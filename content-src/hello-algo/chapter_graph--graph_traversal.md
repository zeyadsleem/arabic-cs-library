...
![Breadth-first search of a graph](/images/hello-algo/chapter_graph--graph_bfs.png)
...
<div class="note">
<p class="note__title">Is the breadth-first traversal sequence unique?</p>
...
![Depth-first search of a graph](/images/hello-algo/chapter_graph--graph_dfs.png)
...
<div class="note">
<p class="note__title">Is the depth-first traversal sequence unique?</p>
