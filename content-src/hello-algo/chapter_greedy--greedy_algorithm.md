...
![Greedy strategy for coin change](/images/hello-algo/chapter_greedy--coin_change_greedy_strategy.png)
...
![Examples where greedy algorithms cannot find the optimal solution](/images/hello-algo/chapter_greedy--coin_change_greedy_vs_dp.png)
