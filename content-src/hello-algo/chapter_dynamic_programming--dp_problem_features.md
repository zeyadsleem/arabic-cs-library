---
title: "Characteristics of Dynamic Programming Problems"
book: hello-algo
...
<div class="note">
<p class="note__title">Climbing stairs with minimum cost</p>
...
![Minimum cost to climb to the 3rd step](/images/hello-algo/chapter_dynamic_programming--min_cost_cs_example.png)
...
![Dynamic programming process for climbing stairs with minimum cost](/images/hello-algo/chapter_dynamic_programming--min_cost_cs_dp.png)
...
<div class="note">
<p class="note__title">Climbing stairs with constraint</p>
...
![Number of ways to climb to the 3rd step with constraint](/images/hello-algo/chapter_dynamic_programming--climbing_stairs_constraint_example.png)
...
![Recurrence relation considering constraints](/images/hello-algo/chapter_dynamic_programming--climbing_stairs_constraint_state_transfer.png)
...
<div class="note">
<p class="note__title">Climbing stairs with obstacle generation</p>
