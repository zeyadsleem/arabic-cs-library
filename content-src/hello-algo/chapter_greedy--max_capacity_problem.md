...
![Example data for the max capacity problem](/images/hello-algo/chapter_greedy--max_capacity_example.png)
...
![Initial state](/images/hello-algo/chapter_greedy--max_capacity_initial_state.png)
...
![State after moving the long partition inward](/images/hello-algo/chapter_greedy--max_capacity_moving_long_board.png)
...
![State after moving the short partition inward](/images/hello-algo/chapter_greedy--max_capacity_moving_short_board.png)
...
![States skipped by moving the short partition](/images/hello-algo/chapter_greedy--max_capacity_skipped_states.png)
