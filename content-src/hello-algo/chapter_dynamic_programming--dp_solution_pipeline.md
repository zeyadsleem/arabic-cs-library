...
![Minimum path sum example data](/images/hello-algo/chapter_dynamic_programming--min_path_sum_example.png)
...
![State definition and dp table](/images/hello-algo/chapter_dynamic_programming--min_path_sum_solution_state_definition.png)
...
![Optimal substructure and state transition equation](/images/hello-algo/chapter_dynamic_programming--min_path_sum_solution_state_transition.png)
...
![Boundary conditions and state transition order](/images/hello-algo/chapter_dynamic_programming--min_path_sum_solution_initial_state.png)
...
![Brute force search recursion tree](/images/hello-algo/chapter_dynamic_programming--min_path_sum_dfs.png)
...
![Memoization recursion tree](/images/hello-algo/chapter_dynamic_programming--min_path_sum_dfs_mem.png)
