---
title: "Integrity Rules and Constraints"
lang: en
---
...
- When you see the 0 symbol for cardinality, you can assume two things: T the FK in the Order table allows nulls, and
...
- Identify cardinality for each relationship, assuming the following rules: A pool may or may not ever have a class.
