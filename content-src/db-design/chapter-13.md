...
- Develop an initial ER diagram and review it with appropriate personnel. (Remember that this is an iterative process.)
...
- Verify ER modeling by normalizing tables.
...
This chapter of Database Design (including all images, except as otherwise noted) is a derivative copy of [The Database Development Life Cycle](http://www.oercommons.org/courses/the-database-development-life-cycle/view) by the Open University licensed under[Creative Commons Attribution-NonCommercial-ShareAlike 3.0 License](http://creativecommons.org/licenses/by-nc-sa/3.0/).
