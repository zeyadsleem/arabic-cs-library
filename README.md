...
| الكتاب | الحالة |
| --- | --- |
| مرحباً والخوارزميات (Hello Algo) — Go + TypeScript | ✅ مترجم بالكامل (117 قسماً) |
| 500 سطر أو أقل (500 Lines or Less) | ✅ 23 فصلاً |
| تصميم قواعد البيانات (Database Design 2e) | ✅ 16 فصلاً + 3 ملاحق |
