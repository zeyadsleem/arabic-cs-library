const s="patterns-dev",a="vanilla",n="أنماط JavaScript",p="preload",l="التحميل المسبق (Preload)",t=[{depth:2,id:"التحميل-المسبق-في-تطبيقات-الصفحة-الواحدة",text:"التحميل المسبق في تطبيقات الصفحة الواحدة"},{depth:2,id:"التحميل-المسبق-مع-حيلة-async",text:"التحميل المسبق مع حيلة async"},{depth:2,id:"التحميل-المسبق-في-chrome-95",text:"التحميل المسبق في Chrome 95+"},{depth:2,id:"الخلاصات",text:"الخلاصات"}],e=`<p><a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Preloading_content">التحميل المسبق</a> (preload) (\`\`) هو <a href="https://web.dev/uses-rel-preload/">تحسين للمتصفح</a> يتيح طلب الموارد الحرجة (التي قد يُتعرَّف عليها متأخرًا) في وقت أبكر. إذا كنت مرتاحًا للتفكير في كيفية ترتيب تحميل مواردك الأساسية يدويًا، فيمكنه أن يكون له أثر إيجابي على أداء التحميل والمقاييس في <a href="https://web.dev/vitals">Core Web Vitals</a>. ومع ذلك، فإن التحميل المسبق ليس حلًا سحريًا ويتطلب الإلمام ببعض المفاضلات.</p>
<p>HTML5 iconindex.html</p>
<pre><code class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;preload&quot;</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;emoji-picker.js&quot;</span> <span class="hljs-attr">as</span>=<span class="hljs-string">&quot;script&quot;</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">head</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;stickers.js&quot;</span> <span class="hljs-attr">defer</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;video-sharing.js&quot;</span> <span class="hljs-attr">defer</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;emoji-picker.js&quot;</span> <span class="hljs-attr">defer</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<pre><code class="language-javascript"><span class="hljs-keyword">const</span> <span class="hljs-title class_">EmojiPicker</span> = <span class="hljs-keyword">import</span>(<span class="hljs-comment">/* webpackPreload: true */</span> <span class="hljs-string">&quot;./EmojiPicker&quot;</span>);
</code></pre>
...
(<span class="hljs-attr">preload</span>: vendors~emoji-picker.<span class="hljs-property">bundle</span>.<span class="hljs-property">js</span> emoji-picker.<span class="hljs-property">bundle</span>.<span class="hljs-property">js</span>)
</code></pre>
...
<pre><code class="language-javascript">&lt;link rel=<span class="hljs-string">&quot;preload&quot;</span> href=<span class="hljs-string">&quot;emoji-picker.js&quot;</span> <span class="hljs-keyword">as</span>=<span class="hljs-string">&quot;script&quot;</span>&gt;

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">&quot;emoji-picker.js&quot;</span> <span class="hljs-attr">async</span>&gt;</span><span class="language-javascript">
</span></span></code></pre>
