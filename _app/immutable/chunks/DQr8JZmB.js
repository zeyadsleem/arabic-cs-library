const s="patterns-dev",e="vue",a="أنماط Vue",n="container-presentational",p="نمط الحاوية/العرضية",t=[{depth:2,id:"المكون-العرضي-presentational-component",text:"المكوّن العرضي (Presentational Component)"},{depth:2,id:"المكونات-الحاوية-container-components",text:"المكوّنات الحاوية (Container Components)"},{depth:2,id:"دوال-التركيب-composables",text:"دوال التركيب (Composables)"},{depth:2,id:"مصادر-مفيدة",text:"مصادر مفيدة"}],l=`<p>في عام 2015، كتب Dan Abramov مقالًا بعنوان <a href="https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0">“المكوّنات العرضية والحاويات” (Presentational and Container Components)</a> غيّر طريقة تفكير كثير من المطوّرين في بنية المكوّنات (component architecture) داخل React. وقد طرح نمطًا يقسم المكوّنات إلى فئتين:</p>
<ul>
...
<p><img src="/images/patterns-dev/vue-container-presentational-0-browse_dogs.webp" alt="تطبيق «تصفّح الكلاب»"></p>
...
<pre><code class="language-javascript">&lt;!-- <span class="hljs-title class_">DogImages</span>.<span class="hljs-property">vue</span> --&gt;

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;(dog, index) in dogs&quot;</span> <span class="hljs-attr">:src</span>=<span class="hljs-string">&quot;dog&quot;</span> <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;index&quot;</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">&quot;Dog&quot;</span> /&gt;</span>
...
<span class="hljs-keyword">const</span> { dogs } = <span class="hljs-title function_">defineProps</span>([<span class="hljs-string">&quot;dogs&quot;</span>]);
...
<pre><code class="language-javascript">&lt;!-- <span class="hljs-title class_">DogImagesContainer</span>.<span class="hljs-property">vue</span> --&gt;

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">DogImages</span> <span class="hljs-attr">:dogs</span>=<span class="hljs-string">&quot;dogs&quot;</span> /&gt;</span>
...
<span class="hljs-keyword">import</span> <span class="hljs-title class_">DogImages</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./DogImages.vue&quot;</span>;

<span class="hljs-keyword">const</span> dogs = <span class="hljs-title function_">ref</span>([]);

<span class="hljs-title function_">onMounted</span>(<span class="hljs-title function_">async</span> () =&gt; {

<span class="hljs-keyword">const</span> response = <span class="hljs-keyword">await</span> <span class="hljs-title function_">fetch</span>(

<span class="hljs-string">&quot;https://dog.ceo/api/breed/labrador/images/random/6&quot;</span>

);

<span class="hljs-keyword">const</span> { message } = <span class="hljs-keyword">await</span> response.<span class="hljs-title function_">json</span>();

dogs.<span class="hljs-property">value</span> = message;
...
<pre><code class="language-javascript">&lt;template&gt;
  <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">DogImages</span> <span class="hljs-attr">:dogs</span>=<span class="hljs-string">&quot;dogs&quot;</span> /&gt;</span></span>
&lt;/template&gt;
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> { ref, onMounted } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;vue&quot;</span>;

<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">useDogImages</span>(<span class="hljs-params"></span>) {
...
<span class="hljs-keyword">return</span> { dogs };
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">v-for</span>=<span class="hljs-string">&quot;(dog, index) in dogs&quot;</span> <span class="hljs-attr">:src</span>=<span class="hljs-string">&quot;dog&quot;</span> <span class="hljs-attr">:key</span>=<span class="hljs-string">&quot;index&quot;</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">&quot;Dog&quot;</span> /&gt;</span></span>

&lt;/template&gt;

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">setup</span>&gt;</span><span class="language-javascript">

<span class="hljs-keyword">import</span> useDogImages <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;../composables/useDogImages&quot;</span>;
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> { ref, onMounted } <span class="hljs-keyword">from</span> &amp;#x27;vue&amp;#x27;;

<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">useDogImages</span>(<span class="hljs-params"></span>) {
  <span class="hljs-keyword">const</span> dogs = <span class="hljs-title function_">ref</span>([]);

<span class="hljs-title function_">onMounted</span>(<span class="hljs-title function_">async</span> () =&gt; {
    <span class="hljs-keyword">const</span> response = <span class="hljs-keyword">await</span> <span class="hljs-title function_">fetch</span>(<span class="hljs-string">&quot;https://dog.ceo/api/breed/labrador/images/random/6&quot;</span>);
    <span class="hljs-keyword">const</span> { message } = <span class="hljs-keyword">await</span> response.<span class="hljs-title function_">json</span>();
    dogs.<span class="hljs-property">value</span> = message;
  });
...
`,o={book:s,chapter:"vue",chapterTitle:a,slug:n,title:p,headings:t,html:l};export{s as book,e as chapter,a as chapterTitle,o as default,t as headings,l as html,n as slug,p as title};
