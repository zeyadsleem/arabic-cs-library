...
<pre><code class="language-javascript"><span class="hljs-keyword">class</span> <span class="hljs-title class_">FeatureFlags</span> {

<span class="hljs-comment">// Private static slot for the one instance</span>

<span class="hljs-keyword">static</span> #instance = <span class="hljs-literal">null</span>;

<span class="hljs-comment">// Private state — invisible outside the class</span>

#flags = <span class="hljs-keyword">new</span> <span class="hljs-title class_">Map</span>();

#loaded = <span class="hljs-literal">false</span>;

<span class="hljs-title function_">constructor</span>(<span class="hljs-params"></span>) {

<span class="hljs-keyword">if</span> (<span class="hljs-title class_">FeatureFlags</span>.#instance) {

<span class="hljs-keyword">return</span> <span class="hljs-title class_">FeatureFlags</span>.#instance;

}

<span class="hljs-title class_">FeatureFlags</span>.#instance = <span class="hljs-variable language_">this</span>;

}

<span class="hljs-keyword">static</span> <span class="hljs-title function_">getInstance</span>(<span class="hljs-params"></span>) {

<span class="hljs-keyword">return</span> (<span class="hljs-title class_">FeatureFlags</span>.#instance ??= <span class="hljs-keyword">new</span> <span class="hljs-title class_">FeatureFlags</span>());

}

<span class="hljs-keyword">async</span> <span class="hljs-title function_">load</span>(<span class="hljs-params">url</span>) {

<span class="hljs-keyword">if</span> (<span class="hljs-variable language_">this</span>.#loaded) <span class="hljs-keyword">return</span>;
...
<span class="hljs-variable language_">this</span>.#flags.<span class="hljs-title function_">set</span>(key, value);

}

<span class="hljs-variable language_">this</span>.#loaded = <span class="hljs-literal">true</span>;

}

<span class="hljs-title function_">isEnabled</span>(<span class="hljs-params">name</span>) {

<span class="hljs-keyword">return</span> <span class="hljs-variable language_">this</span>.#flags.<span class="hljs-title function_">get</span>(name) === <span class="hljs-literal">true</span>;

}

}

<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-title class_">FeatureFlags</span>;
</code></pre>
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> <span class="hljs-title class_">FeatureFlags</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./feature-flags.js&quot;</span>;

<span class="hljs-keyword">const</span> flags = <span class="hljs-title class_">FeatureFlags</span>.<span class="hljs-title function_">getInstance</span>();

<span class="hljs-keyword">await</span> flags.<span class="hljs-title function_">load</span>(<span class="hljs-string">&quot;/config/flags.json&quot;</span>);

<span class="hljs-keyword">if</span> (flags.<span class="hljs-title function_">isEnabled</span>(<span class="hljs-string">&quot;new-checkout&quot;</span>)) {

<span class="hljs-comment">// render the new flow</span>
...
<pre><code class="language-javascript"><span class="hljs-comment">// feature-flags.js</span>

<span class="hljs-keyword">const</span> flags = <span class="hljs-keyword">new</span> <span class="hljs-title class_">Map</span>();

<span class="hljs-keyword">let</span> loaded = <span class="hljs-literal">false</span>;
...
flags.<span class="hljs-title function_">set</span>(key, value);
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">isEnabled</span>(<span class="hljs-params">name</span>) {

<span class="hljs-keyword">return</span> flags.<span class="hljs-title function_">get</span>(name) === <span class="hljs-literal">true</span>;
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> { container, singleton, inject } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;tsyringe&quot;</span>;

@<span class="hljs-title function_">singleton</span>()

<span class="hljs-keyword">class</span> <span class="hljs-title class_">AnalyticsClient</span> {

<span class="hljs-title function_">track</span>(<span class="hljs-params">event: string, props: Record&lt;string, unknown&gt;</span>) { <span class="hljs-comment">/* ... */</span> }

}

<span class="hljs-keyword">class</span> <span class="hljs-title class_">CheckoutService</span> {

<span class="hljs-title function_">constructor</span>(<span class="hljs-params">@inject(AnalyticsClient) private analytics: AnalyticsClient</span>) {}

<span class="hljs-title function_">complete</span>(<span class="hljs-params">orderId: string</span>) {

<span class="hljs-variable language_">this</span>.<span class="hljs-property">analytics</span>.<span class="hljs-title function_">track</span>(<span class="hljs-string">&quot;order_completed&quot;</span>, { orderId });

}

}

<span class="hljs-keyword">const</span> checkout = container.<span class="hljs-title function_">resolve</span>(<span class="hljs-title class_">CheckoutService</span>);
</code></pre>
...
<pre><code class="language-javascript"><span class="hljs-keyword">const</span> <span class="hljs-title class_">FeatureFlagsContext</span> = <span class="hljs-title function_">createContext</span>(<span class="hljs-literal">null</span>);

<span class="hljs-keyword">export</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">FeatureFlagsProvider</span>(<span class="hljs-params">{ client, children }</span>) {

<span class="hljs-keyword">return</span> (

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">FeatureFlagsContext.Provider</span> <span class="hljs-attr">value</span>=<span class="hljs-string">{client}</span>&gt;</span>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">useFeatureFlag</span>(<span class="hljs-params">name</span>) {

<span class="hljs-keyword">const</span> client = <span class="hljs-title function_">useContext</span>(<span class="hljs-title class_">FeatureFlagsContext</span>);

<span class="hljs-keyword">return</span> client.<span class="hljs-title function_">isEnabled</span>(name);
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">const</span> useSession = <span class="hljs-title function_">create</span>(<span class="hljs-function">(<span class="hljs-params">set</span>) =&gt;</span> ({

<span class="hljs-attr">user</span>: <span class="hljs-literal">null</span>,

<span class="hljs-attr">login</span>: <span class="hljs-function">(<span class="hljs-params">user</span>) =&gt;</span> <span class="hljs-title function_">set</span>({ user }),
...
<pre><code class="language-javascript"><span class="hljs-comment">// Hidden dependency</span>
...
<span class="hljs-title class_">Logger</span>.<span class="hljs-title function_">getInstance</span>().<span class="hljs-title function_">info</span>(<span class="hljs-string">&quot;processing&quot;</span>, order.<span class="hljs-property">id</span>);

}

<span class="hljs-comment">// Explicit — the contract is in the signature</span>

<span class="hljs-keyword">function</span> <span class="hljs-title function_">processOrder</span>(<span class="hljs-params">order, logger</span>) {

logger.<span class="hljs-title function_">info</span>(<span class="hljs-string">&quot;processing&quot;</span>, order.<span class="hljs-property">id</span>);
