...
<span class="hljs-keyword">const</span> user = <span class="hljs-keyword">await</span> <span class="hljs-title function_">fetchUser</span>(session?.<span class="hljs-property">value</span>);

<span class="hljs-keyword">const</span> widgets = <span class="hljs-keyword">await</span> <span class="hljs-title function_">fetchWidgets</span>(user.<span class="hljs-property">id</span>);\\n
...
<span class="hljs-tag">&lt;<span class="hljs-name">WidgetGrid</span> <span class="hljs-attr">widgets</span>=<span class="hljs-string">{widgets}</span> /&gt;</span>
...
`,p={book:s,chapter:n,chapterTitle:a,slug:e,title:t,headings:l,html:o};export{s as book,n as chapter,a as chapterTitle,p as default,l as headings,o as html,e as slug,t as title};
