const s="patterns-dev",e="vue",n="أنماط Vue",a="async-components",p="المكوّنات غير المتزامنة",l=[{depth:2,id:"defineasynccomponent",text:"defineAsyncComponent"},{depth:2,id:"واجهة-التحميل-وواجهة-الخطأ",text:"واجهة التحميل وواجهة الخطأ"},{depth:3,id:"loadingcomponent",text:"loadingComponent"},{depth:3,id:"errorcomponent",text:"errorComponent"},{depth:2,id:"مصادر-مفيدة",text:"مصادر مفيدة"}],t=`<p>عند تطوير تطبيقات ويب كبيرة، يكون الأداء في الصدارة. فسرعة تحميل الصفحة وسرعة استجابة عناصرها التفاعلية يمكن أن يؤثّرا كثيرًا في تجربة المستخدم. ومع نمو تطبيقات الويب في الحجم والتعقيد، يصبح من المهمّ ضمان تحميل حزم الشيفرة الكبيرة فقط عند الحاجة إليها. وهنا تدخل المكوّنات غير المتزامنة في Vue.</p>
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;modal-mask&quot;</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">h3</span>&gt;</span>This is the modal!<span class="hljs-tag">&lt;/<span class="hljs-name">h3</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;modal-default-button&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;$emit(&#x27;close&#x27;)&quot;</span>&gt;</span>OK<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="language-css">

<span class="hljs-selector-class">.modal-mask</span> {
...
<span class="hljs-attribute">box-shadow</span>: <span class="hljs-number">0</span> <span class="hljs-number">2px</span> <span class="hljs-number">8px</span> <span class="hljs-built_in">rgba</span>(<span class="hljs-number">0</span>, <span class="hljs-number">0</span>, <span class="hljs-number">0</span>, <span class="hljs-number">0.33</span>);

<span class="hljs-attribute">transition</span>: all <span class="hljs-number">0.3s</span> ease;

}

<span class="hljs-selector-class">.modal-body</span> <span class="hljs-selector-tag">h3</span> {
...
<span class="hljs-selector-class">.modal-default-button</span> {
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;show-modal&quot;</span> @<span class="hljs-attr">click</span>=<span class="hljs-string">&quot;showModal = true&quot;</span>&gt;</span>Show Modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span></span>

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">Modal</span> <span class="hljs-attr">v-if</span>=<span class="hljs-string">&quot;showModal&quot;</span> <span class="hljs-attr">:show</span>=<span class="hljs-string">&quot;showModal&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;showModal = false&quot;</span> /&gt;</span></span>
...
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Modal</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./components/Modal.vue&quot;</span>;
...
<p><img src="/images/patterns-dev/vue-async-components-0-simple_modal.webp" alt="نافذة منبثقة بسيطة"></p>
...
<p><img src="/images/patterns-dev/vue-async-components-1-modal_bundle_initial_load.webp" alt="حزمة النافذة محمّلة عند فتح الصفحة"></p>
...
<span class="hljs-comment">// ...load component from the server</span>

<span class="hljs-title function_">resolve</span>(<span class="hljs-comment">/* loaded component */</span>);
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">const</span> <span class="hljs-title class_">AsyncComp</span> = <span class="hljs-title function_">defineAsyncComponent</span>(<span class="hljs-function">() =&gt;</span>

<span class="hljs-keyword">import</span>(<span class="hljs-string">&quot;./components/MyComponent.vue&quot;</span>)
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">const</span> <span class="hljs-title class_">AsyncModal</span> = <span class="hljs-title function_">defineAsyncComponent</span>();
</code></pre>
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">const</span> <span class="hljs-title class_">AsyncModal</span> = <span class="hljs-title function_">defineAsyncComponent</span>(<span class="hljs-function">() =&gt;</span> <span class="hljs-keyword">import</span>(<span class="hljs-string">&quot;./Modal.vue&quot;</span>));
</code></pre>
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">AsyncModal</span> <span class="hljs-attr">v-if</span>=<span class="hljs-string">&quot;showModal&quot;</span> <span class="hljs-attr">:show</span>=<span class="hljs-string">&quot;showModal&quot;</span> @<span class="hljs-attr">close</span>=<span class="hljs-string">&quot;showModal = false&quot;</span> /&gt;</span></span>
...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">AsyncModal</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./components/AsyncModal&quot;</span>;
...
<p><img src="/images/patterns-dev/vue-async-components-2-modal_bundle_no_initial_load.webp" alt="حزمة النافذة غير محمّلة عند فتح الصفحة"></p>
...
<p><img src="/images/patterns-dev/vue-async-components-3-modal_async_load.webp" alt="حزمة النافذة محمّلة بشكل غير متزامن"></p>
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Loading...<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span></span>
...
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Loading</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./Loading.vue&quot;</span>;
...
<p><img src="/images/patterns-dev/vue-async-components-4-modal_loading_component.webp" alt="مكوّن التحميل أثناء جلب الحزمة"></p>
...
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Error!<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span></span>
...
<span class="hljs-keyword">import</span> <span class="hljs-title class_">Error</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./Error.vue&quot;</span>;
...
<p><img src="/images/patterns-dev/vue-async-components-5-modal_error_component.webp" alt="مكوّن الخطأ عند فشل جلب الحزمة"></p>
...
`,o={book:s,chapter:"vue",chapterTitle:n,slug:a,title:p,headings:l,html:t};export{s as book,e as chapter,n as chapterTitle,o as default,l as headings,t as html,a as slug,p as title};
