const e="patterns-dev",s="vue",n="أنماط Vue",t="render-functions",o="دوال العرض",r=[{depth:2,id:"لكن-لماذا",text:"لكن لماذا؟"},{depth:2,id:"دوال-العرض",text:"دوال العرض"},{depth:2,id:"دوال-العرض-وjsx",text:"دوال العرض وJSX"},{depth:2,id:"المكونات-الوظيفية",text:"المكوّنات الوظيفية"},{depth:2,id:"الخلاصة",text:"الخلاصة"},{depth:2,id:"مصادر-مفيدة",text:"مصادر مفيدة"}],d=`<p>يوصي Vue بأن نستخدم القوالب (أي صيغة \`\`) لبناء ترميز (markup) مكوّنات Vue. غير أننا نُتاح لنا أيضًا فرصة استخدام ما يُعرف بـ <strong>دوال العرض</strong> (render functions) مباشرة لبناء ترميز مكوّناتنا كذلك.</p>
...
<pre><code>function RenderComponent(props, { slots, emit, attrs }) {
  // ...
}
...
<pre><code>function RenderComponent(props) {
  return (
    &lt;div class=&quot;render-card&quot;&gt;
...
<p><img src="/images/patterns-dev/vue-render-functions-73-render_function.webp" alt="دوال العرض"></p>
`,p={book:e,chapter:"vue",chapterTitle:n,slug:t,title:o,headings:r,html:d};export{e as book,s as chapter,n as chapterTitle,p as default,r as headings,d as html,t as slug,o as title};
