const s="patterns-dev",a="react",n="أنماط React وNext.js",l="compound-pattern",p="النمط المركّب",t=[{depth:2,id:"واجهة-السياق-context-api",text:"واجهة السياق (Context API)"},{depth:2,id:"reactchildrenmap",text:"React.Children.map"},{depth:2,id:"المميزات",text:"المميزات"},{depth:2,id:"العيوب",text:"العيوب"},{depth:2,id:"المراجع",text:"المراجع"}],e=`<p>في تطبيقنا، لدينا غالبًا مكوّنات (components) تخصّ بعضها بعضًا. فهي تعتمد على بعضها عبر الحالة (state) المشتركة، وتتشارك المنطق معًا. ونرى هذا غالبًا في مكوّنات مثل <code>select</code>، ومكوّنات القوائم المنسدلة (dropdown)، أو عناصر القوائم. يتيح لك <strong>نمط المكوّنات المركّبة (compound component pattern)</strong> إنشاء مكوّنات تعمل جميعها معًا لإنجاز مهمة واحدة.</p>
...
<pre><code class="language-javascript"><span class="hljs-keyword">const</span> <span class="hljs-title class_">FlyOutContext</span> = <span class="hljs-title function_">createContext</span>();

<span class="hljs-keyword">function</span> <span class="hljs-title function_">FlyOut</span>(<span class="hljs-params">props</span>) {

<span class="hljs-keyword">const</span> [open, toggle] = <span class="hljs-title function_">useState</span>(<span class="hljs-literal">false</span>);

<span class="hljs-keyword">return</span> (

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">FlyOutContext.Provider</span> <span class="hljs-attr">value</span>=<span class="hljs-string">{{</span> <span class="hljs-attr">open</span>, <span class="hljs-attr">toggle</span> }}&gt;</span>

{props.children}

<span class="hljs-tag">&lt;/<span class="hljs-name">FlyOutContext.Provider</span>&gt;</span></span>
...
<pre><code class="language-javascript"><span class="hljs-keyword">function</span> <span class="hljs-title function_">Toggle</span>(<span class="hljs-params"></span>) {

<span class="hljs-keyword">const</span> { open, toggle } = <span class="hljs-title function_">useContext</span>(<span class="hljs-title class_">FlyOutContext</span>);

<span class="hljs-keyword">return</span> (

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">onClick</span>=<span class="hljs-string">{()</span> =&gt;</span> toggle(!open)}&gt;
...
<span class="hljs-keyword">import</span> { <span class="hljs-title class_">FlyOut</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./FlyOut&quot;</span>;

<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">FlyoutMenu</span>(<span class="hljs-params"></span>) {

<span class="hljs-keyword">return</span> (

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">FlyOut</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">FlyOut.Toggle</span> /&gt;</span>

<span class="hljs-tag">&lt;/<span class="hljs-name">FlyOut</span>&gt;</span></span>
...
<pre><code class="language-javascript"><span class="hljs-keyword">function</span> <span class="hljs-title function_">List</span>(<span class="hljs-params">{ children }</span>) {
...
<span class="hljs-keyword">return</span> open &amp;&amp; <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span>&gt;</span>{children}<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></span>;

}

<span class="hljs-keyword">function</span> <span class="hljs-title function_">Item</span>(<span class="hljs-params">{ children }</span>) {

<span class="hljs-keyword">return</span> <span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>{children}<span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span></span>;
...
<span class="hljs-keyword">const</span> { open } = <span class="hljs-title function_">useContext</span>(<span class="hljs-title class_">FlyOutContext</span>);
...
<span class="hljs-tag">&lt;<span class="hljs-name">FlyOut.List</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">FlyOut.Item</span>&gt;</span>Edit<span class="hljs-tag">&lt;/<span class="hljs-name">FlyOut.Item</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">FlyOut.Item</span>&gt;</span>Delete<span class="hljs-tag">&lt;/<span class="hljs-name">FlyOut.Item</span>&gt;</span>
...
<pre><code class="language-javascript"><span class="hljs-keyword">export</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">FlyOut</span>(<span class="hljs-params">props</span>) {
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> { <span class="hljs-title class_">FlyOut</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./FlyOut&quot;</span>;
...
<pre><code class="language-javascript"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> <span class="hljs-keyword">function</span> <span class="hljs-title function_">FlyoutMenu</span>(<span class="hljs-params"></span>) {
