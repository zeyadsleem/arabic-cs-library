const s="hello-algo",a="chapter_greedy",n="الخوارزميات الجشعة",p="fractional_knapsack_problem",l="مسألة الحقيبة الكسرية",t=[{depth:3,id:"تحديد-الاستراتيجية-الجشعة",text:"تحديد الاستراتيجية الجشعة"},{depth:3,id:"تنفيذ-الشيفرة",text:"تنفيذ الشيفرة"},{depth:3,id:"إثبات-الصحة",text:"إثبات الصحة"}],e=`<div class="note">
