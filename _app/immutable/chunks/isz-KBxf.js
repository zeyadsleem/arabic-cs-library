const e="patterns-dev",t="vanilla",i="أنماط JavaScript",n="virtual-lists",o="افتراضية القوائم (List Virtualization)",r=[{depth:2,id:"كيف-تعمل-افتراضية-القوائم",text:"كيف تعمل افتراضية القوائم؟"},{depth:2,id:"بديل-أصغر-لـ-react-virtualized",text:"بديل أصغر لـ react-virtualized"},{depth:3,id:"القائمة",text:"القائمة"},{depth:3,id:"الشبكة",text:"الشبكة"},{depth:2,id:"أمثلة-react-window-الأكثر-تفصيلا",text:"أمثلة react-window الأكثر تفصيلًا"},{depth:2,id:"ما-الذي-ينقص-react-window",text:"ما الذي ينقص react-window؟"},{depth:2,id:"التحسينات-في-منصة-الويب",text:"التحسينات في منصة الويب"},{depth:2,id:"قراءة-إضافية",text:"قراءة إضافية"}],a=`<p>في هذا الدليل، سنناقش افتراضية القوائم (list virtualization)، المعروفة أيضًا باسم النوافذ (windowing). الفكرة هي عرض الصفوف المرئية فقط من قائمة ديناميكية بدلًا من القائمة كاملة. وتكون الصفوف المعروضة جزءًا صغيرًا فقط، مع تحريك الجزء المرئي (النافذة) عندما يمرر المستخدم. ويمكن أن يحسّن هذا أداء العرض (rendering performance).</p>
...
<p><img src="/images/patterns-dev/vanilla-virtual-lists-43-frame_rate_10k_2x.webp" alt="List Virtualization"> <img src="/images/patterns-dev/vanilla-virtual-lists-44-bundlephobia_2x.webp" alt="List Virtualization"> <img src="/images/patterns-dev/vanilla-virtual-lists-45-wbpa_2x.webp" alt="List Virtualization"> <img src="/images/patterns-dev/vanilla-virtual-lists-46-tmdb_2x.webp" alt="List Virtualization"></p>
`,s={book:e,chapter:t,chapterTitle:i,slug:n,title:o,headings:r,html:a};export{e as book,t as chapter,i as chapterTitle,s as default,r as headings,a as html,n as slug,o as title};
