const n="hello-algo",s="chapter_divide_and_conquer",e="التقسيم والتغلب",a="build_binary_tree_problem",l="مسألة بناء شجرة ثنائية",r=[{depth:3,id:"تحديد-ما-إذا-كانت-المسألة-من-مسائل-التقسيم-والتغلب",text:"تحديد ما إذا كانت المسألة من مسائل التقسيم والتغلب"},{depth:3,id:"كيفية-تقسيم-الأشجار-الفرعية",text:"كيفية تقسيم الأشجار الفرعية"},{depth:3,id:"تمثيل-مجالات-الأشجار-الفرعية-بالمتغيرات",text:"تمثيل مجالات الأشجار الفرعية بالمتغيرات"},{depth:3,id:"تنفيذ-الشيفرة",text:"تنفيذ الشيفرة"}],o=`<div class="note">
...
`,d={book:n,chapter:s,chapterTitle:e,slug:a,title:l,headings:r,html:o};export{n as book,s as chapter,e as chapterTitle,d as default,r as headings,o as html,a as slug,l as title};
