const s="patterns-dev",a="vanilla",n="أنماط JavaScript",e="prefetch",t="الجلب المسبق (Prefetch)",p=[{depth:2,id:"الجلب-المسبق",text:"الجلب المسبق"}],l=`<p>الجلب المسبق (prefetch) (\`\`) هو تحسين للمتصفح يتيح لنا جلب الموارد التي قد تكون مطلوبة للمسارات (routes) أو الصفحات اللاحقة قبل أن نحتاج إليها. ويمكن تحقيق الجلب المسبق بعدة طرق. ويمكن تحقيق ذلك بشكل مصرَّح به في HTML (كما في المثال أدناه)، أو عبر ترويسة HTTP (<code>Link: ; rel=prefetch</code>)، أو عبر <a href="https://googlechrome.github.io/samples/service-worker/prefetch/">Service Workers</a>، أو عبر وسائل أكثر تخصيصًا مثل Webpack.</p>
<pre><code>&lt;link rel=&quot;prefetch&quot; href=&quot;/pages/next-page.html&quot; /&gt;
...
<pre><code>const EmojiPicker = import(/* webpackPrefetch: true */ &quot;./EmojiPicker&quot;);
</code></pre>
...
`,c={book:s,chapter:a,chapterTitle:n,slug:e,title:t,headings:p,html:l};export{s as book,a as chapter,n as chapterTitle,c as default,p as headings,l as html,e as slug,t as title};
