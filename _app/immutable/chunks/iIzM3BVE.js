const s="patterns-dev",n="vanilla",t="أنماط JavaScript",a="prpl",e="نمط PRPL (PRPL Pattern)",l=[{depth:2,id:"مراجعة-سريعة-للأعمدة-الأربعة",text:"مراجعة سريعة للأعمدة الأربعة"},{depth:2,id:"لماذا-وجد-prpl-في-المقام-الأول",text:"لماذا وُجد PRPL في المقام الأول"},{depth:2,id:"الدفع-من-دفع-الخادم-إلى-early-hints",text:"الدفع: من دفع الخادم إلى Early Hints"},{depth:2,id:"العرض-تحسين-lcp-لا-التفاعلية",text:"العرض: تحسين LCP، لا «التفاعلية»"},{depth:2,id:"التخزين-المسبق-عامل-الخدمة-الجلب-المسبق-وحواف-cdn",text:"التخزين المسبق: عامل الخدمة، الجلب المسبق، وحواف CDN"},{depth:2,id:"التحميل-الكسول-الأوليات-الأصلية-تكفي-عادة",text:"التحميل الكسول: الأوليات الأصلية تكفي عادةً"},{depth:2,id:"هل-ما-زال-هيكل-التطبيق-موجودا",text:"هل ما زال هيكل التطبيق موجودًا؟"},{depth:2,id:"هل-ما-زال-prpl-الإطار-الصحيح",text:"هل ما زال PRPL الإطار الصحيح؟"},{depth:2,id:"المراجع",text:"المراجع"}],p=`<p>PRPL — <strong>الدفع، العرض، التخزين المسبق، التحميل الكسول (Push, Render, Pre-cache, Lazy-load)</strong> — هي استراتيجية طورتها Google عام 2016 لجعل تطبيقات الويب قابلة للاستخدام على شبكات الهاتف المحمول المتقطعة والهواتف ضعيفة الإمكانات. كان هذا النمط سائدًا في التسليم ذو الأولوية الأولى من نحو 2016 حتى 2019؛ ولا تزال أعمدتها نصائح جيدة اليوم، لكن <em>التنفيذات</em> تطورت. زال دفع الخادم (server push) من Chrome، وامتزجت هياكل التطبيقات (app shells) إلى حد كبير مع SSR الحديث مع البث، وأصبحت المقاييس التي نقيسها LCP وINP بدلاً من تقديرات time-to-interactive.</p>
...
<pre><code class="language-javascript">&lt;link rel=<span class="hljs-string">&quot;preload&quot;</span> href=<span class="hljs-string">&quot;/fonts/inter.woff2&quot;</span> <span class="hljs-keyword">as</span>=<span class="hljs-string">&quot;font&quot;</span> type=<span class="hljs-string">&quot;font/woff2&quot;</span> crossorigin&gt;

<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;modulepreload&quot;</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;/assets/app.js&quot;</span>&gt;</span>
</span></code></pre>
...
<pre><code class="language-javascript"><span class="hljs-variable constant_">HTTP</span>/<span class="hljs-number">1.1</span> <span class="hljs-number">103</span> <span class="hljs-title class_">Early</span> <span class="hljs-title class_">Hints</span>

<span class="hljs-title class_">Link</span>: &lt;<span class="hljs-regexp">/assets/</span>app.<span class="hljs-property">js</span>&gt;; rel=preload; <span class="hljs-keyword">as</span>=script

<span class="hljs-title class_">Link</span>: &lt;<span class="hljs-regexp">/assets/</span>app.<span class="hljs-property">css</span>&gt;; rel=preload; <span class="hljs-keyword">as</span>=style

<span class="hljs-variable constant_">HTTP</span>/<span class="hljs-number">1.1</span> <span class="hljs-number">200</span> <span class="hljs-variable constant_">OK</span>

<span class="hljs-title class_">Content</span>-<span class="hljs-title class_">Type</span>: text/html
...
<pre><code class="language-javascript"><span class="hljs-keyword">import</span> { registerRoute } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;workbox-routing&quot;</span>;

<span class="hljs-keyword">import</span> { <span class="hljs-title class_">StaleWhileRevalidate</span>, <span class="hljs-title class_">CacheFirst</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;workbox-strategies&quot;</span>;
...
<span class="hljs-function">(<span class="hljs-params">{ request }</span>) =&gt;</span> request.<span class="hljs-property">destination</span> === <span class="hljs-string">&quot;script&quot;</span>,

<span class="hljs-keyword">new</span> <span class="hljs-title class_">StaleWhileRevalidate</span>({ <span class="hljs-attr">cacheName</span>: <span class="hljs-string">&quot;scripts&quot;</span> })
...
<span class="hljs-attr">plugins</span>: [<span class="hljs-keyword">new</span> <span class="hljs-title class_">ExpirationPlugin</span>({ <span class="hljs-attr">maxEntries</span>: <span class="hljs-number">60</span>, <span class="hljs-attr">maxAgeSeconds</span>: <span class="hljs-number">30</span> * <span class="hljs-number">24</span> * <span class="hljs-number">60</span> * <span class="hljs-number">60</span> })],
...
`,o={book:s,chapter:n,chapterTitle:t,slug:a,title:e,headings:l,html:p};export{s as book,n as chapter,t as chapterTitle,o as default,l as headings,p as html,a as slug,e as title};
