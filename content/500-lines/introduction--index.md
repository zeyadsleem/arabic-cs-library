...
title: "مقدّمة"
lang: ar
source: https://aosabook.org/en/500L/introduction.html
---

*500 سطر أو أقل*
=======================

> "ما لا أستطيع صناعته، لا أفهمه."
>
> -- ريتشارد فاينمان

هذا هو مصدر كتاب *500 سطر أو أقل*، وهو الكتاب الرابع في سلسلة
[هندسة تطبيقات مفتوحة المصدر](http://aosabook.org). وكما في الكتب الأخرى
في هذه السلسلة، ستغطي جميع النصوص المكتوبة رخصة المشاع الإبداعي - نسب
المصنف، وستغطي جميع الشيفرةَ رخصة MIT؛ انظر
[وصف الرخصة](https://github.com/aosabook/500lines/blob/master/LICENSE.md) للتفاصيل. وإضافةً إلى ذلك، ستذهب كل إيرادات
النسخ المدفوعة إلى منظمة العفو الدولية.

أصبح إصدار هذا الكتاب ممكناً بفضل الدعم المالي من
...
يدرس كل مهندس معماري، أثناء تدريبه، بيوت الأسرة والشقق والمدارس
...
(spreadsheet) خلاياه، وكيف تخزّن قاعدة البيانات (database) البيانات بكفاءة.

وقد فعلت كتب الأسبقية في سلسلة AOSA ذلك بوصف البنية المعمارية
...
لم يضطروا بعد إلى بناء أي شيء بهذا المقياس.

يركّز كتاب "500 سطر أو أقل" على قرارات التصميم والمقايضات التي يتخذها
المبرمجون ذوو الخبرة وهم يكتبون الشيفرة:

*   لماذا نقسم التطبيق إلى هذه الوحدات (modules) بالذات وبهذه الواجهات
    (interfaces) بالذات؟
*   لماذا نستخدم الوراثة (inheritance) هنا والتركيب (composition) هناك؟
*   كيف يمكننا أن نتنبأ بالأماكن التي قد يحتاج فيها برنامجنا إلى التوسّع،
    وكيف يمكننا أن نجعل ذلك سهلاً على بقية المبرمجين؟

يتكوّن كل فصل من استعراض شامل لبرنامج يحلّ مشكلة كلاسيكية في هندسة البرمجيات
